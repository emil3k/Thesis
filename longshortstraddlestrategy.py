# -*- coding: utf-8 -*-
"""
Created on Sun Apr 11 15:08:07 2021
...
for i in np.arange(0, nDays - lag - 1):
    ...
    elif gammaSignal == True and currentPos == 1: #Keep the same position
    ...
    if gammaSignal == False and currentPos == -1: #Keep the same short position
