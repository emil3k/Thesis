...
longUncondPerformance = bt.ComputePerformance(uncondStraddleReturnsLongScaled, RfDaily, 0, 252)
shortUncondPerformance = bt.ComputePerformance(uncondStraddleReturnsShortScaled, RfDaily, 0, 252)
...
longShortPerformanceTC = bt.ComputePerformance(straddleReturnsLSTC, RfDaily, 0, 25)
...
perfList = [longPerformanceTC, shortPerformanceTC, longShortPerformanceTC]
test     = constructPerformanceDf(perfList, colNames = colNames, to_latex = True)
