...
loadlocAgg            = "../Data/AggregateData/"
loadlocOpt            = "../Data/CleanData/"
loadlocSpot           = "../Data/SpotData/SpotData.xlsx"
prefColor             = '#0504aa' 
...
[PSR_long, SR_long, SR2_long] = bt.PSR(gtStraddleLongXsReturns + RfDaily[1:] , uncondStraddleReturnsLongScaled[1:] + RfDaily[1:], RfDaily[1:], AnnualizationFactor = 252)
[PSR_short, SR_short, SR2_short] = bt.PSR(gtStraddleShortXsReturns + RfDaily[1:], uncondStraddleReturnsShortScaled[1:] + RfDaily[1:], RfDaily[1:], AnnualizationFactor = 252)
